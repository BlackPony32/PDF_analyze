...
def AI_generation_plots_summary(_data_dict):
    ...
    plan = Task(
        description="""Task Description:
                        ...
                        Analyze a CSV file and generate insightful visualizations using Plotly. (Use different chart style)
                        The provided folders and file paths are already set up, so there's no need to check their existence.
                        ...
                        -Functional code for each visualizations.
                        - use different plot style, colors
                        - summary of the visualizations - For example, that in a certain period of time, sales have dropped,
                        and why is this so according to the data received
                        It should be visualizations for all data not only that you get/
                        ...
                        Important And call func with variable inside like task_1_visualization(df)
    ...
    data_config ={
        'data_path': 'src/uploads/cleaned_data.csv',
